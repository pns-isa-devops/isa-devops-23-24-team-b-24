...
public interface AdvantageApplier {
    ...
    PointTransaction apply(Customer customer, Advantage advantage, Leisure leisure) throws NegativeAmountTransactionException, AlreadyExistingException, IdNotFoundException;
