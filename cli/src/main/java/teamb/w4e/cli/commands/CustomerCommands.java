...
public class CustomerCommands {
    ...
    @ShellMethod("Register a customer in the CoD backend (register-customer CUSTOMER_NAME CREDIT_CARD_NUMBER)")
    public CliCustomer registerCustomer(String name, String creditCard) {
